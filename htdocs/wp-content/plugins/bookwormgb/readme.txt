=== BookwormGB - Page Builder Gutenberg Blocks ===
...
[BookwormGB](https://madrasthemes.com) is one of the first and most expansive block library made specially for the new WordPress Block Editor (Gutenberg). It adds essential custom blocks to Gutenberg’s arsenal to achieve a smooth page building experience. With its latest iteration, BookwormGB brings a suite of high quality blocks for page building, with precision design tools that let you build the perfect website and landing page that you want.

[youtube https://www.youtube.com/watch?v=m2I-pCYPezk]

With BookwormGB, you get:
...
Whether you are a DIYer, business owner, graphic artist or a web agency, BookwormGB is just the WordPress custom block collection you’ve been waiting for.

See BookwormGB in action by checking out our demo. Visit our [website](https://madrasthemes.com) (made with Gutenberg + BookwormGB blocks) to learn even more about BookwormGB.

## The Easiest and Most Straightforward Way to Build Page Sections

BookwormGB lets you reimagine the way you use the WordPress Block Editor for a truly easy and intuitive way of building stunning web pages. With BookwormGB, you can build entire page sections by using a single block with the built-in section / background controls. There’s really nothing like it.

BookwormGB blocks are designed to be highly versatile and usable either as:

1. units that can be combined with other blocks, or
2. stand-alone sections, which can easily be achieved by turning on the block background settings (a uniquely BookwormGB feature).

Having this flexibility makes BookwormGB an all-in-one tool for building your website.
...
BookwormGB now offers the most advanced block design controls with the widest range of design settings. With this block collection, enjoy:
...
All of BookwormGB's powerful options are easily managed in an intuitive UI for a smooth block editing experience. This is achieved by our three-tab configuration, easy toggle on/off for block elements, and streamlined settings.
...
## BookwormGB WordPress Theme

Get our WordPress theme that's beautiful & flexible, Gutenberg-ready and made especially for BookwormGB blocks and the new WordPress editor. [Download the BookwormGB Theme now](http://eepurl.com/dJY9xI).

## BookwormGB Premium

[BookwormGB Premium](https://madrasthemes.com/premium) extends the capabilities of BookwormGB and the new WordPress editor to give you the smoothest page building experience. Using the core BookwormGB Philosophy of balancing utility and great design, BookwormGB Premium offers:
...
While you can create great pages with BookwormGB, BookwormGB Premium lets you do so much more.

Try out a [live demo of BookwormGB Premium](https://demo.madrasthemes.com/v2/)
...
- [v1.16 Translations: BookwormGB in Your Language](https://madrasthemes.com/blog/translations-BookwormGB-in-your-language/)
...
- [v1.13 Introducing BookwormGB Premium](https://madrasthemes.com/blog/introducing-BookwormGB-premium/)
- [v1.12 BookwormGB Is Now in GitHub](https://madrasthemes.com/blog/BookwormGB-is-now-in-github/)
- [v1.11 Huge Updates Across All Blocks](https://madrasthemes.com/blog/huge-updates-across-all-blocks/)

### Learn More About BookwormGB - Gutenberg Blocks

- [Join the BookwormGB Community in Facebook](https://www.facebook.com/groups/wpBookwormGB/)
- [Visit us in madrasthemes.com](https://madrasthemes.com)
- [Twitter @madrasthemes](https://twitter.com/madrasthemes)
- [Facebook Page WPBookwormGB](https://www.facebook.com/BookwormGB-870555573068267/)
- [What is BookwormGB?](https://madrasthemes.com/blog/welcome-to-BookwormGB/)
...
BookwormGB gives you lots of awesome blocks for you to create awesome landing pages and front pages.

**Can I use this with other block plugins?**

Yes! BookwormGB blocks play well with other blocks.

**Can I use this add-on for other page builders I’m using?**

Nope. BookwormGB only works with Gutenberg, the new WordPress editor.
...
= 2.2.0 =
[Welcome Video, Better Separators and Auto-Block Recovery](https://madrasthemes.com/blog/welcome-video-better-separators-and-auto-block-recovery/)

* New: Welcome to BookwormGB modal popup
...
* Fixed: Only apply default z-index to BookwormGB blocks
...
= 2.1.0 =
[Help Video Snippets and Auto-Expand Settings](https://madrasthemes.com/blog/help-video-snippets-auto-expand-settings/)
...
* New: Affiliation menu, become a BookwormGB Affiliate!
...
* Added: BookwormGB_enqueue_styles PHP filter
* Added: BookwormGB_enqueue_scripts PHP filter
* Added: BookwormGB_enqueue_fonts PHP filter

= 2.0.1 =
* Fixed: Possible posts block migration error

= 2.0 =
[Version 2 is Out!](https://madrasthemes.com/blog/version-2-is-out)
...
= 1.17.0 =
[Text Color and Text Highlight](https://madrasthemes.com/blog/text-color-and-text-highlight)
...
= 1.16.0 =
[Translations: BookwormGB in Your Language](https://madrasthemes.com/blog/translations-bookwormgb-in-your-language/)
